# Generated by Django 3.2.6 on 2022-03-29 10:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(max_length=50)),
                ('orgid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user_interface.org')),
                ('userid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user_interface.user1')),
            ],
        ),
        migrations.CreateModel(
            name='meeting',
